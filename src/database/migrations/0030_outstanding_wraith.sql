...
ALTER TABLE "material_purchase_requisition_items" ADD CONSTRAINT "material_purchase_requisition_items_material_code_materials_code_fk" FOREIGN KEY ("material_code") REFERENCES "public"."materials"("code") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
