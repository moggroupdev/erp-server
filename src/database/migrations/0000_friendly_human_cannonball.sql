...
CREATE TABLE "boms" (
	...
	CONSTRAINT "boms_quantity_required_positive" CHECK ("boms"."quantity_required" > 0),
	CONSTRAINT "boms_unit_cost_positive" CHECK ("boms"."unit_cost" > 0)
);
...
--> statement-breakpoint
CREATE TABLE "contract_item_dimensions" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	...
	CONSTRAINT "contract_item_dimensions_contract_item_id_unique" UNIQUE("contract_item_id"),
	CONSTRAINT "contract_item_dimensions_length_non_negative" CHECK ("contract_item_dimensions"."length" >= 0),
	CONSTRAINT "contract_item_dimensions_width_non_negative" CHECK ("contract_item_dimensions"."width" >= 0),
	CONSTRAINT "contract_item_dimensions_height_non_negative" CHECK ("contract_item_dimensions"."height" >= 0)
);
--> statement-breakpoint
...
CREATE TABLE "deliveries" (
	...
	CONSTRAINT "deliveries_delivered_cancelled_exclusive" CHECK ("deliveries"."delivered_at" IS NULL OR "deliveries"."cancelled_at" IS NULL),
	CONSTRAINT "deliveries_delivered_at_gte_scheduled_at" CHECK ("deliveries"."delivered_at" IS NULL OR "deliveries"."scheduled_at" IS NULL OR "deliveries"."delivered_at" >= "deliveries"."scheduled_at"),
...
CREATE TABLE "product_boms" (
	...
	CONSTRAINT "product_boms_quantity_required_positive" CHECK ("product_boms"."quantity_required" > 0)
);
--> statement-breakpoint
...
CREATE TABLE "production_plan_items" (
	...
	"completed_at" timestamp with time zone,
	"notes" text,
	CONSTRAINT "production_plan_items_plan_unit_dept_unique" UNIQUE("plan_id","product_unit_id","production_department_id"),
...
CREATE TABLE "installations" (
	...
	CONSTRAINT "installations_installed_cancelled_exclusive" CHECK ("installations"."installed_at" IS NULL OR "installations"."cancelled_at" IS NULL),
	CONSTRAINT "installations_installed_at_gte_scheduled_at" CHECK ("installations"."installed_at" IS NULL OR "installations"."scheduled_at" IS NULL OR "installations"."installed_at" >= "installations"."scheduled_at"),
...
ALTER TABLE "contract_item_dimensions" ADD CONSTRAINT "contract_item_dimensions_contract_item_id_contract_items_id_fk" FOREIGN KEY ("contract_item_id") REFERENCES "public"."contract_items"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "production_plan_items" ADD CONSTRAINT "production_plan_items_production_department_id_departments_id_fk" FOREIGN KEY ("production_department_id") REFERENCES "public"."departments"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "product_purchase_order_items" ADD CONSTRAINT "product_purchase_order_items_contract_item_id_contract_items_id_fk" FOREIGN KEY ("contract_item_id") REFERENCES "public"."contract_items"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "contracts_code_idx" ON "contracts" USING btree ("code");--> statement-breakpoint
...
CREATE INDEX "production_plan_items_production_department_id_idx" ON "production_plan_items" USING btree ("production_department_id");--> statement-breakpoint
...
CREATE INDEX "product_units_installed_at_idx" ON "product_units" USING btree ("installed_at");