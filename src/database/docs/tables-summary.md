...
| material_purchase_requisitions                 | uuid        | MPReq | derived (any gate rejected) | YES       | YES (NOT NULL) |
...
| maintenance_order_materials                    | uuid        | —     | NO                          | NO        | NO             |
...
| audit_logs                                     | uuid        | —     | NO (append-only)            | YES       | NO             |
