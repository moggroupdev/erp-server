...
- Supplier invoices: tax/e-invoice documents linked to a material purchase order (or, later, an outsourcing order); one order may have multiple invoices over time
