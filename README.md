...
- Supplier invoices: tax/e-invoice documents linked to exactly one of a material purchase order, product purchase order, or outsourcing order; one order may have multiple invoices over time; each invoice may store an optional PDF attachment uploaded after the invoice exists
